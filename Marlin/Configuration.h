...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 242.66 //rado
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 40, 400 }  //rado
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.122 // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 40, -1.60 } //rado
...
#define XY_PROBE_SPEED (120*60) //rado
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (40*60) //rado
